...
import edu.wustl.honeyrj.protocol.SSHProtocol;
import edu.wustl.honeyrj.protocol.HttpProtocol;
...
public class HoneyRJMain {
	...
	private static void createSampleProtocols() {
		...
		LIProtocol sshP = new SSHProtocol();
		LIModule sshM = new LIModule(sshP);
		LIProtocol httpP = new HttpProtocol();
		LIModule httpM = new LIModule(httpP);
